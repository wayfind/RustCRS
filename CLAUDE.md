...
# E2E 回归测试（Claude Console 端到端测试）
bash tests/regression/test-claudeconsole-e2e.sh 60     # 1分钟快速测试
bash tests/regression/test-claudeconsole-e2e.sh 300    # 5分钟标准测试（默认）
bash tests/regression/test-claudeconsole-e2e.sh 600    # 10分钟深度测试
...
tests/                          🧪 回归测试套件
  regression/     - 端到端回归测试
    test-claudeconsole-e2e.sh  - Claude Console E2E 测试脚本
    README.md                   - 测试使用说明
